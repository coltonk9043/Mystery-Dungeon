...
namespace DungeonGame.Levels
{
    public class World
    {
        ...
        public World(string dungeonName)
        {
            ...
            this.addEntity((Entity)new NPCDavid(new Vector3(72f, 38f, 0.0f)));
            this.addEntity((Entity)new ItemEntity(new Vector3(72f, 100f, 0.0f), Game1.Items.GetItem("elesis_claymore")));
            this.addEntity((Entity)new ItemEntity(new Vector3(45f, 46f, 0.0f), Game1.Items.GetItem("elesis_claymore")));
            this.addEntity((Entity)new ItemEntity(new Vector3(125f, 150f, 0.0f), Game1.Items.GetItem("torch")));
            this.addEntity((Entity)new ItemEntity(new Vector3(150f, 150f, 0.0f), Game1.Items.GetItem("ruby")));
            this.addEntity((Entity)new ItemEntity(new Vector3(150f, 175f, 0.0f), Game1.Items.GetItem("ruby")));
            this.addEntity((Entity)new ItemEntity(new Vector3(150f, 200f, 0.0f), Game1.Items.GetItem("ruby_staff")));
            this.addEntity((Entity)new ItemEntity(new Vector3(175f, 150f, 0.0f), Game1.Items.GetItem("sapphire")));
            this.addEntity((Entity)new ItemEntity(new Vector3(175f, 175f, 0.0f), Game1.Items.GetItem("sapphire")));
            this.addEntity((Entity)new ItemEntity(new Vector3(175f, 200f, 0.0f), Game1.Items.GetItem("sapphire_staff")));
            this.addEntity((Entity)new ItemEntity(new Vector3(200f, 150f, 0.0f), Game1.Items.GetItem("emerald")));
            this.addEntity((Entity)new ItemEntity(new Vector3(200f, 175f, 0.0f), Game1.Items.GetItem("emerald")));
            this.addEntity((Entity)new ItemEntity(new Vector3(200f, 200f, 0.0f), Game1.Items.GetItem("emerald_staff")));
            this.addEntity((Entity)new ItemEntity(new Vector3(225f, 150f, 0.0f), Game1.Items.GetItem("diamond")));
            this.addEntity((Entity)new ItemEntity(new Vector3(225f, 175f, 0.0f), Game1.Items.GetItem("diamond")));
            this.addEntity((Entity)new ItemEntity(new Vector3(225f, 200f, 0.0f), Game1.Items.GetItem("diamond_staff")));
            this.addEntity((Entity)new ItemEntity(new Vector3(250f, 150f, 0.0f), Game1.Items.GetItem("copper_ingot")));
            this.addEntity((Entity)new ItemEntity(new Vector3(250f, 175f, 0.0f), Game1.Items.GetItem("copper_hatchet")));
            this.addEntity((Entity)new ItemEntity(new Vector3(250f, 200f, 0.0f), Game1.Items.GetItem("copper_scythe")));
            this.addEntity((Entity)new ItemEntity(new Vector3(250f, 225f, 0.0f), Game1.Items.GetItem("copper_pickaxe")));
            this.addEntity((Entity)new ItemEntity(new Vector3(250f, 250f, 0.0f), Game1.Items.GetItem("copper_sword")));
            this.addEntity((Entity)new ItemEntity(new Vector3(250f, 275f, 0.0f), Game1.Items.GetItem("copper_knife")));
            this.addEntity((Entity)new ItemEntity(new Vector3(275f, 150f, 0.0f), Game1.Items.GetItem("iron_ingot")));
            this.addEntity((Entity)new ItemEntity(new Vector3(275f, 175f, 0.0f), Game1.Items.GetItem("iron_hatchet")));
            this.addEntity((Entity)new ItemEntity(new Vector3(275f, 200f, 0.0f), Game1.Items.GetItem("iron_scythe")));
            this.addEntity((Entity)new ItemEntity(new Vector3(275f, 225f, 0.0f), Game1.Items.GetItem("iron_pickaxe")));
            this.addEntity((Entity)new ItemEntity(new Vector3(275f, 250f, 0.0f), Game1.Items.GetItem("iron_sword")));
            this.addEntity((Entity)new ItemEntity(new Vector3(275f, 275f, 0.0f), Game1.Items.GetItem("iron_knife")));
            this.addEntity((Entity)new ItemEntity(new Vector3(300f, 150f, 0.0f), Game1.Items.GetItem("tungsten_ingot")));
            this.addEntity((Entity)new ItemEntity(new Vector3(300f, 175f, 0.0f), Game1.Items.GetItem("tungsten_hatchet")));
            this.addEntity((Entity)new ItemEntity(new Vector3(300f, 200f, 0.0f), Game1.Items.GetItem("tungsten_scythe")));
            this.addEntity((Entity)new ItemEntity(new Vector3(300f, 225f, 0.0f), Game1.Items.GetItem("tungsten_pickaxe")));
            this.addEntity((Entity)new ItemEntity(new Vector3(300f, 250f, 0.0f), Game1.Items.GetItem("tungsten_sword")));
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                this.skyColor = new Color((int)(255.0 - 255.0 * ((this.time - 12000.0) / 6000.0)), (int)(255.0 - 255.0 * ((this.time - 12000.0) / 6000.0)), (int)(255.0 - 255.0 * ((this.time - 12000.0) / 6000.0)));
                this.skyAlpha = (float)(255.0 - 255.0 * ((this.time - 12000.0) / 6000.0));
            }
            else if (this.time >= 22000.0 && this.time < 24000.0)
            {
                this.skyColor = new Color((int)(0.0 + 81.0 * ((this.time - 22000.0) / 2000.0)), (int)(0.0 + 81.0 * ((this.time - 22000.0) / 2000.0)), (int)(0.0 + 81.0 * ((this.time - 22000.0) / 2000.0)));
        ...
        public void Draw(SpriteBatch spriteBatch, Camera camera)
        {
            ...
            spriteBatch.Draw(this.renderTargetWorld, new Rectangle(0, 0, Game1.ScreenWidth, Game1.ScreenHeight), Color.White);
            spriteBatch.End();

            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.None, RasterizerState.CullCounterClockwise);
            spriteBatch.Draw(this.renderTargetShadows, new Rectangle(0, 0, Game1.ScreenWidth, Game1.ScreenHeight), new Color(255, 255, 255, 80));
            spriteBatch.End();

            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.None, RasterizerState.CullCounterClockwise, effect: this.lightingEffect);
            spriteBatch.Draw(this.renderTargetEntities, new Rectangle(0, 0, Game1.ScreenWidth, Game1.ScreenHeight), Color.White);
            spriteBatch.End();
        }
